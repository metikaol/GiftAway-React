  ...
  render () {
    ...
    return (
      <main className="container mt-3">
        <Button className="ml-3" outline color="info"
          onClick={this.toggle}
              ...
              post => (
                <div key={post.id} className="card blog">
                  <div className="card-body">
                    ...
                    <Link className="ml-2" style={{fontSize: 20}}
                      to={`/posts/${post.id}`}>
                        {post.title}
                    </Link>
                    <p className="ml-2"><img width="35px" height="35px"
                      className="rounded" src={LocationIcon} />
                      {post.address}
                    </p>
