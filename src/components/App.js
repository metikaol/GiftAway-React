  ...
  render() {
    ...
    return (<Router>
      <div className="App">
        ...
        <Switch>
          <Route exact="exact" path="/" render={props => <HomePage {...props} onSignIn={this.signIn}/>}/>
          <AuthRoute isAuthenticated={this.isSignedIn()} user={user} exact="exact" path="/posts" component={PostIndexPage}/>
          <AuthRoute isAuthenticated={this.isSignedIn()} path="/posts/new" component={PostNewPage}/>
          <AuthRoute isAuthenticated={this.isSignedIn()} path="/posts/:id/edit" component={PostEditPage}/>
          <AuthRoute isAuthenticated={this.isSignedIn()} path="/posts/:id" component={PostShowPage}/>
          <AuthRoute isAuthenticated={this.isSignedIn()} path="/map" component={Map}/> {/* <Route path="/sign_in" component={HomePage} /> */}
          <Route path="/sign_in" render={props => (<HomePage {...props} onSignIn={this.signIn}/>)}/>
