...
class SignInPage extends Component {
  ...
  render() {
    ...
    return (
    <section id="cover" className="SignInPage"
      // style={{margin: '0 1rem'}}
>
            ...
            <form onSubmit={this.createToken}>
              ...
              <div className="form-group mr-3">
                ...
                <input type='email' id='email'
                  style={{fontSize: 20}} className="form-control form-control-lg" name='email' placeholder="Email"/>
              </div>
              ...
              <div className="form-group">
                ...
                <br/>
                <input type='password' id='password' style={{fontSize: 20}} className="form-control form-control-lg" name='password' placeholder="Password"/>
              </div>
              </div>
